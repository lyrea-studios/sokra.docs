...
description: Find the right workspace and choose your first task in Lyrea.
---
...
Open [Lyrea](https://app.sokra.io) or your invitation link. Use your usual account or your organization's sign-in method. If you cannot get in, follow [Sign in to Lyrea](../sign-in/).
...
Lyrea has **School**, **Enterprise**, **Higher Education**, and **Workspace** modes. Workspace is the personal mode for self-directed learning. [Compare the modes](../../workspaces/modes/) to see what each changes.
